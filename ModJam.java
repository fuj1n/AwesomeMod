...
public class ModJam {
	...
	public static int[] woodChairIDs = { 1025, 1026, 1027, 1028 };
	public static int[] stoneChairIDs = { 1029, 1030, 1031, 1032 };
	...
	public void initAllItems() {
		...
		woodChair = new ItemChair(woodChairID, 0, ModJam.woodChairIDs[0]).setCreativeTab(modJamCreativeTab).setUnlocalizedName("woodChair");
		stoneChair = new ItemChair(stoneChairID, 1, ModJam.stoneChairIDs[0]).setCreativeTab(modJamCreativeTab).setUnlocalizedName("stoneChair");
	...
	public void addAllCrafting() {
		for (int i = 0; i < 16; i++) {
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(woodChair, 1, i), new Object[] { "PXX", "PPP", "PXP", Character.valueOf('P'), Block.planks, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(woodChair, 1, i), new Object[] { "XXP", "PPP", "PXP", Character.valueOf('P'), Block.planks, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(stoneChair, 1, i), new Object[] { "SXX", "SSS", "SXS", Character.valueOf('S'), Block.stone, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(stoneChair, 1, i), new Object[] { "XXS", "SSS", "SXS", Character.valueOf('S'), Block.stone, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(woodTable, 1, i), new Object[] { "XXX", "PPP", "PXP", Character.valueOf('P'), Block.planks, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(stoneTable, 1, i), new Object[] { "XXX", "SSS", "SXS", Character.valueOf('S'), Block.stone, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeIngot, 8, 15), new Object[] { "XXX", "XDX", "XXX", Character.valueOf('D'), "extractDark", Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeBlockStandard, 1, i), new Object[] { "XXX", "XBX", "XXX", Character.valueOf('B'), awesomeBlock, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
			CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeBlockCreeper, 1, i), new Object[] { "XGX", "XBX", "XGX", Character.valueOf('B'), awesomeBlock, Character.valueOf('G'), Item.gunpowder, Character.valueOf('X'), "ingotAwesome" + awesomeColors[i] }));
		}
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeHelmet, 1, 0), new Object[] { " X ", "XHX", " X ", Character.valueOf('H'), Item.helmetIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeChestplate, 1, 0), new Object[] { " X ", "XCX", " X ", Character.valueOf('C'), Item.plateIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeLeggings, 1, 0), new Object[] { " X ", "XLX", " X ", Character.valueOf('L'), Item.legsIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeBoots, 1, 0), new Object[] { " X ", "XBX", " X ", Character.valueOf('B'), Item.bootsIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomePickaxe, 1, 0), new Object[] { " X ", "XPX", " X ", Character.valueOf('P'), Item.pickaxeIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeShovel, 1, 0), new Object[] { " X ", "XSX", " X ", Character.valueOf('S'), Item.shovelIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeSword, 1, 0), new Object[] { " X ", "XSX", " X ", Character.valueOf('S'), Item.swordIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeAxe, 1, 0), new Object[] { " X ", "XAX", " X ", Character.valueOf('A'), Item.axeIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeHoe, 1, 0), new Object[] { " X ", "XHX", " X ", Character.valueOf('H'), Item.hoeIron, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(awesomeBlock, 1, 0), new Object[] { " X ", "XSX", " X ", Character.valueOf('S'), Block.stone, Character.valueOf('X'), "ingotAwesomeBlack" }));
		CraftingManager.getInstance().getRecipeList().add(new ShapedOreRecipe(new ItemStack(rotationTool, 1, 0), new Object[] { "XC ", "CS ", "  S", Character.valueOf('C'), Block.cobblestone, Character.valueOf('S'), Item.stick, Character.valueOf('X'), "ingotAwesomeLime" }));
	}
	...
	public static void addHeadRecipe() {
		...
		GameRegistry.addShapedRecipe(head, new Object[] { "OIO", "IEI", "OIO", Character.valueOf('O'), new ItemStack(awesomeOre, 1, 5), Character.valueOf('I'), new ItemStack(awesomeIngot, 1, 5), Character.valueOf('E'), darkExtract });
	}
	...
	public void populateGenChest() {
		...
		ComponentChestContents.addItemGen(Block.blockIron, 0, 1, 2, 1);
