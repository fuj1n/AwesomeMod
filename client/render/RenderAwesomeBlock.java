...
public class RenderAwesomeBlock implements ISimpleBlockRenderingHandler {
	...
	public void renderInventoryBlock(Block block, int metadata, int modelID, RenderBlocks renderer) {
		...
		if (modelID == ClientProxyModJam.awesomeBlockRenderType) {
			...
			renderer.renderFaceYPos(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			...
			tessellator.setNormal(0F, -1.0F, 0F);
			renderer.setRenderBounds(0.0001, 0.0001, 0.0001, 0.9999, 0.9999, 0.9999);
			renderer.renderFaceYNeg(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
			...
			renderer.setRenderBounds(0.0001, 0.0001, 0.0001, 0.9999, 0.9999, 0.9999);
			renderer.renderFaceZNeg(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
			...
			renderer.setRenderBounds(0.0001, 0.0001, 0.0001, 0.9999, 0.9999, 0.9999);
			renderer.renderFaceXPos(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
			...
			tessellator.setNormal(+1.0F, 0F, 0F);
			renderer.setRenderBounds(0.0001, 0.0001, 0.0001, 0.9999, 0.9999, 0.9999);
			renderer.renderFaceZPos(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
			...
			tessellator.setNormal(0F, 0F, +1.0F);
			renderer.setRenderBounds(0.0001, 0.0001, 0.0001, 0.9999, 0.9999, 0.9999);
			renderer.renderFaceXNeg(block, 0.0D, 0.0D, 0.0D, handlerBlock.getUnderlyingTexture(1, metadata));
			renderer.setRenderBounds(0, 0, 0, 1, 1, 1);
