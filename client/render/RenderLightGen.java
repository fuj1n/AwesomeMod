...
public class RenderLightGen implements ISimpleBlockRenderingHandler {
	...
	public void renderAttachedHandles(IBlockAccess world, int x, int y, int z, Block block, int modelId, RenderBlocks renderer) {
		...
		if (world.getBlockId(x, y + 1, z) == ModJam.woodTable.blockID || world.getBlockId(x, y + 1, z) == ModJam.stoneTable.blockID) {
			topHandleHeight = 1.9;
		} else if (world.getBlockId(x, y + 1, z) == ModJam.woodChairIDs[0] || world.getBlockId(x, y + 1, z) == ModJam.woodChairIDs[1] || world.getBlockId(x, y + 1, z) == ModJam.woodChairIDs[2] || world.getBlockId(x, y + 1, z) == ModJam.woodChairIDs[3] || world.getBlockId(x, y + 1, z) == ModJam.stoneChairIDs[0] || world.getBlockId(x, y + 1, z) == ModJam.stoneChairIDs[1] || world.getBlockId(x, y + 1, z) == ModJam.stoneChairIDs[2] || world.getBlockId(x, y + 1, z) == ModJam.stoneChairIDs[3]) {
			topHandleHeight = 1.6;
		}
